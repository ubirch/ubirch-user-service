...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "client-rest" % "0.6.1"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "cmdtools" % "0.6.1"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "model-db" % "0.6.1"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "model-rest" % "0.6.1"
)
```
