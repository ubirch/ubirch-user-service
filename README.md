...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "client-rest" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "cmdtools" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "config" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "core" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "model-db" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "model-rest" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "server" % "0.4.11-SNAPSHOT"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "util" % "0.4.11-SNAPSHOT"
)
```
