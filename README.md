...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "client-rest" % "0.4.17"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "cmdtools" % "0.4.17"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "model-db" % "0.4.17"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.user" %% "model-rest" % "0.4.17"
)
```
