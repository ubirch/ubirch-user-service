...
lazy val ubirchMongo = ubirchUtilG %% "mongo-utils" % "0.9.0" excludeAll (excludedLoggers: _*)
lazy val ubirchMongoTest = ubirchUtilG %% "mongo-test-utils" % "0.9.0" excludeAll (excludedLoggers: _*)
