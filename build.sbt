...
lazy val ubirchMongoTest = ubirchUtilG %% "mongo-test-utils" % "0.2.3" excludeAll(excludedLoggers: _*)
lazy val ubirchMongo = ubirchUtilG %% "mongo-utils" % "0.2.3" excludeAll(excludedLoggers: _*)
