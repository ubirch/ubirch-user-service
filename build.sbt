...
lazy val ubirchDeepCheckModel = ubirchUtilG %% "deep-check-model" % "0.1.0-SNAPSHOT" excludeAll(excludedLoggers: _*)
...
lazy val ubirchMongoTest = ubirchUtilG %% "mongo-test-utils" % "0.3.0-SNAPSHOT" excludeAll(excludedLoggers: _*)
lazy val ubirchMongo = ubirchUtilG %% "mongo-utils" % "0.3.0-SNAPSHOT" excludeAll(excludedLoggers: _*)
